...
pub use generator::{
    ...
    calculate_net_delta, calculate_news_impact, calculate_ratio_signal, calculate_time_decay,
    calculate_wall_bias, calculate_weighted_imbalance, combine_bayesian, default_category_weights,
    detect_big_move, detect_exhaustion, detect_momentum_exhaustion, detect_reversal, detect_stall,
    detect_walls, is_cascade, is_funding_extreme_30d, parse_sentiment, percentile_signal,
    BigMoveResult, CascadeConfig, CombinationMethod, CompositeSignal, CorrelationMatrix,
    ExhaustionConfig, ExhaustionSignal, FundingPercentileConfig, FundingRateSignal,
    FundingReversalConfig, FundingSignalMode, LiquidationAggregate24h, LiquidationCascadeSignal,
    LiquidationRatioConfig, LiquidationRatioSignal, LiquidationSignalMode,
    MomentumExhaustionConfig, MomentumExhaustionSignal, NewsSignal, OrderBookImbalanceSignal,
    ReversalSignal, Side, Wall, WallBias, WallDetectionConfig, WallSemantics,
};
