...
ExecStart=/home/ubuntu/venv/bin/python -m openclaw position-manager --mode paper --poll-interval 30 --db-url postgres://algo:algo_trade_local@localhost/algo_trade
Restart=always
RestartSec=10
...
WorkingDirectory=/home/ubuntu/python
EnvironmentFile=/home/ubuntu/.env
ExecStart=/home/ubuntu/venv/bin/python -m openclaw scheduler --db-url postgres://algo:algo_trade_local@localhost/algo_trade
Restart=always
RestartSec=10
